...
public class PlantEditor : Editor {
    public override void OnInspectorGUI() {
        ...
        if (model.getMolecules().Length != 0) EditorGUILayout.PropertyField(serializedObject.FindProperty("molecules"), true);
        if (model.getToxicity() != "") GUILayout.Label("Toxicity: " + model.getToxicity());
